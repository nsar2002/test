...
WORK=Path("v6_m3f3_work")
OUT=Path("v6_m3f3_out")
...
def main():
    ...
    if len(a)<8 or len(b)<8:
        report={
            "gate":"V6-M3F3_AMIN_A1B1_OFFICIAL_ROI_ORDINAL_HOLDOUT",
            "classification":"BLOCKED_M3F3_SOURCE_PAIRING_INSUFFICIENT",
            "source_sha256":got,
        ...
        cls="PASS_M3F3_INDEPENDENT_ORDINAL_APL_LOCALITY" if passed else "FAIL_M3F3_INDEPENDENT_ORDINAL_APL_LOCALITY"
        report={
            "gate":"V6-M3F3_AMIN_A1B1_OFFICIAL_ROI_ORDINAL_HOLDOUT",
            "classification":cls,
            "source_sha256":got,
    ...
    (OUT/"v6_m3f3_result.json").write_text(json.dumps(report,indent=2,sort_keys=True)+"\n")
